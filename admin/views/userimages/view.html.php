...
class InstaimagesViewUserimages  extends JView {
	...
	public function display($tpl = null) 
	{
		...
		$context			= 'com_instaimages'.'.'.strtolower($this->getName()).'.list.';
	...
	public function _displayForm($tpl)
	{
		...
		JHTML::stylesheet( 'fields.css', 'administrator/components/com_instaimages/assets/' );
